...
class Analogy(object):
    ...
    def Word_Analogy(self, analogy, vec):
        queue = mp.Queue()
        # category = ['capital1', 'capital2', 'currency', 'city', 'family', 'gram1', 'gram2', 'gram3', 'gram4', 'gram5', 'gram6', 'gram7', 'gram8', 'gram9']
        category = ['gram1', 'gram2', 'gram3', 'gram4', 'gram5', 'gram6', 'gram7', 'gram8', 'gram9']
